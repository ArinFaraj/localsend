...
class SettingsService extends PureNotifier<SettingsState> {
  ...
  SettingsState init() => SettingsState(
    ...
    copyToClipboard: _persistence.isCopyToClipboard(),
  ...
  Future<void> setCopyToClipboard(bool copyToClipboard) async {
    await _persistence.setCopyToClipboard(copyToClipboard);
    state = state.copyWith(copyToClipboard: copyToClipboard);
  }
